# -*- coding: utf-8 -*-
#
# Programmeerimine (MTAT.03.100) documentation build configuration file, created by
...
project = u'Programmeerimine (MTAT.03.100)'
...
language = 'et'
#locale_dirs = ['sphinx-extra-locales', '../sphinx-extra-locales']
...
html_theme_path = ['sphinx-extra-themes', '../sphinx-extra-themes']
...
html_title = "Programmeerimine (MTAT.03.100). Arvutipraktikumi materjalid"
...
htmlhelp_basename = 'ProgrammeerimineMTAT03100doc'
